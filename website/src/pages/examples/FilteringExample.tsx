...
export function FilteringExample() {
  const example = {
    ...
    description:
      "Learn how to implement column filtering with various filter types including text, number range, and date filters.",
    stackblitzUrl:
      "https://stackblitz.com/github/ricsam/react-tanstack-table-ui/tree/main/examples/filtering?embed=1&theme=dark&preset=node&file=src/app.tsx",
    codesandboxUrl:
      "https://codesandbox.io/p/devbox/github/ricsam/react-tanstack-table-ui/tree/main/examples/filtering",
  };
