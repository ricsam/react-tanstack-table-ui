...
export function FilteringExample() {
  const example = {
    ...
    stackblitzUrl: 'https://stackblitz.com/github/ricsam/virtualized-table/tree/main/examples/full?embed=1&theme=dark&preset=node&file=src/filtering.tsx',
    codesandboxUrl: 'https://codesandbox.io/p/devbox/github/ricsam/virtualized-table/tree/main/examples/full',
  };
