...
export function VirtualExample() {
  const example = {
    ...
    description:
      "This example demonstrates how to implement virtualized scrolling for large datasets, improving performance with thousands of rows.",
    stackblitzUrl:
      "https://stackblitz.com/github/ricsam/react-tanstack-table-ui/tree/main/examples/virtual?embed=1&theme=dark&preset=node&file=src/app.tsx",
    codesandboxUrl:
      "https://codesandbox.io/p/devbox/github/ricsam/react-tanstack-table-ui/tree/main/examples/virtual",
  };
