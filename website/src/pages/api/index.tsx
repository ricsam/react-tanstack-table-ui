  ...
  return (
    <div className="prose max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="prose max-w-none mb-12">
        <h1>API Reference</h1>
        <p>
          Comprehensive documentation of the React TanStack Table UI API,
              ...
              <div className="border-t border-gray-200">
                <dl>
                      ...
                      <table className="min-w-full divide-y divide-gray-300 dark:divide-gray-600">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                          ...
                          <tr>
                            ...
                            <td className="px-3 py-4 text-sm text-gray-500 dark:text-gray-400">
                              Number of rows to render outside of the visible
                              area (default: <code>10</code>)
                            </td>
                          </tr>
                          <tr>
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 dark:text-white">
                            ...
                            <td className="px-3 py-4 text-sm text-gray-500 dark:text-gray-400">
                              Number of columns to render outside of the visible
                              area (default: <code>3</code>)
                            </td>
                          </tr>
                          <tr>
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 dark:text-white">
                            ...
                            <td className="px-3 py-4 text-sm text-gray-500 dark:text-gray-400">
                              Handler for row drag-and-drop functionality
                            </td>
                          </tr>
                          <tr>
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 dark:text-white">
                            ...
                            <td className="px-3 py-4 text-sm text-gray-500 dark:text-gray-400">
                              Handler for column drag-and-drop functionality
                            </td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700/50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100 sm:mt-0 sm:col-span-2">
                      <p>
                        The <code>ReactTanstackTableUi</code> component is the
                        main entry point for using React TanStack Table UI. It
                        provides a complete table solution with virtualization,
                        sorting, filtering, and other features.
                      </p>
                      <p className="mt-2">
                        This component integrates TanStack Table with TanStack
                        Virtual to create high-performance tables for large
                        datasets. When virtualization is enabled, only the
                        visible rows are rendered, significantly improving
                        performance with large datasets.
                      </p>
                      <p className="mt-2">
                        To use this component, you need to create a table
                        instance using the <code>useReactTable</code> hook from{" "}
                        <code>@tanstack/react-table</code> and pass it to the{" "}
              ...
              <div className="border-t border-gray-200">
                <dl>
                  ...
                  <div className="bg-white dark:bg-gray-800 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100 sm:mt-0 sm:col-span-2">
                      <code>header: Header</code> - The header object from
                      TanStack Table
                    </dd>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100 sm:mt-0 sm:col-span-2">
                      <code>VirtualHeader</code> - An object with properties to
                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                          <tr>
                            ...
                            <td className="px-3 py-4 text-sm text-gray-500">
                              Whether this is a header or footer cell
                            </td>
                          </tr>
                          <tr>
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                          ...
                          <tr>
                            ...
                            <td className="px-3 py-4 text-sm text-gray-500">
                              Whether the header is pinned (and to which side)
                            </td>
                          </tr>
                          <tr>
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                          ...
                          <tr>
                            ...
                            <td className="px-3 py-4 text-sm text-gray-500">
                              Index of the header in the column array
                            </td>
                          </tr>
                          <tr>
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                            ...
                            <td className="px-3 py-4 text-sm text-gray-500">
                              Reference to the original header object
                            </td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700/50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100 sm:mt-0 sm:col-span-2">
                      <p>
                        ...
                        correctly with the virtual scrolling and other table
                        features.
                      </p>
                      <p className="mt-2">
                        This hook is typically used when creating a custom skin
                        by overriding the <code>HeaderCell</code> component in
                        the skin object passed to the{" "}
                        <code>ReactTanstackTableUi</code> component.
                      </p>
                      <p className="mt-2">
                        See the{" "}
                        <a
