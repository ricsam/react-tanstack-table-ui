...
// Remove MobileNavigation component and replace with MobileHeader
      ...
      <div className="px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="p-2 rounded-lg text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800"
  ...
  return (
    <div className="min-h-screen flex bg-white dark:bg-gray-900">
      ...
      {isMobile && sidebarOpen && (
        <div 
          className="fixed inset-0 bg-gray-600 bg-opacity-75 z-40 transition-opacity duration-300 ease-in-out"
      ...
      <aside
        ...
        } h-screen flex-shrink-0 border-r border-gray-200 dark:border-gray-700 flex flex-col bg-white dark:bg-gray-900`}
      >
        ...
        <div
          className={`flex-shrink-0 p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 ${!sidebarOpen && !isMobile && "justify-center"}`}
        >
      ...
      {/* Main content */}
      <div className={`flex-1 flex flex-col ${isMobile ? "md:ml-0" : ""}`}>
        <main className={`flex-1 overflow-auto ${isMobile && !sidebarOpen ? "pt-16" : ""}`}>
